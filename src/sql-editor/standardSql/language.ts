...
import { SQLMonarchLanguage } from 'sql-editor/types';
...
export const OR = 'OR';
export const LOGICAL_OPERATORS = [AND, OR, 'ALL', 'ANY',
'BETWEEN',
'EXISTS',
'IN',
'LIKE',
...
// based on https://github.com/microsoft/monaco-editor/edit/main/src/basic-languages/sql/sql.ts
